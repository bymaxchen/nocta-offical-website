    ...
    return (
      <div className="px-6 py-8 max-w-3xl mx-auto bg-black">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold leading-snug mb-6">
          We build purposeful, scalable tools for modern businesses
        </h2>
        <p>
          From full products to standalone modules or fast MVPs.Our work is reliable, lean, and built to scale with your ambition.
        </p>
      </div>
    );
  }